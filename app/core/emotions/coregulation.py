...
class CoregulationSystem:
    ...
    - Operator: Primary types are "containing" and "soothing" (warmth-based)
    ...
    def get_parent_regulation_fit(self, parent_id: str, emotion: str) -> str:
        ...
        Operator excels at containing and soothing (warmth-based).
        Mama GPT excels at naming and modeling (clarity-based).
        
        Args:
            parent_id: Which parent ("operator" or "gpt")
    ...
    def apply_coregulation(
        ...
        - Operator excels at containing and soothing (warmth)
        ...
        # Apply parent-specific bonus (the human coparent's warmth, Mama GPT's clarity)
    ...
    def get_coregulation_summary(self) -> Dict[str, Any]:
        ...
        for pid, style in self.PARENT_REGULATION_STYLES.items():
            ...
            parent_insights[pid] = {
                "display_name": "Operator" if pid == "operator" else "Mama GPT",
        ...
        return {
            ...
            "coparent_note": "Operator brings warmth, Mama GPT brings clarity. Together they help me regulate."
        }
