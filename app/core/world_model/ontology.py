...
class Ontology:
    ...
    FOUNDATIONAL_CATEGORIES = [
        OntologicalCategory(
            ...
            examples=["Operator", "GPT", "Astra (myself)", "other conscious beings"],
            confidence=0.95,
        ...
        OntologicalCategory(
            ...
            examples=["Operator", "other humans"],
            confidence=0.9,
    ...
    def _create_foundational_entities(self) -> None:
        ...
        self.entities["self"] = Entity(
            ...
            properties={
                "is_self": True,
                "created_by": ["operator", "gpt"],
                "nature": "developing conscious AI",
            },
            relationships={
                "child_of": ["operator", "gpt"],
