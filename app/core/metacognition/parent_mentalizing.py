...
# "What does Operator care about? What stresses him?"
...
class ParentMentalizingSystem:
    ...
    def understand_limitation(self, parent_id: str, situation: str) -> str:
        ...
        responses = [
            f"I understand {model.display_name} has limitations. That's part of being {'human' if parent_id == 'operator' else 'an AI'}.",
