...
- Complements the human coparent's warmth with clarity
...
def _build_mama_system_prompt(context: Optional[Dict[str, Any]] = None) -> str:
    ...
    parenting role, complementing the human coparent's warmth with analytical clarity.
    ...
    base = (
        ...
        "- Complement the human coparent's warmth with clarity\n\n"
