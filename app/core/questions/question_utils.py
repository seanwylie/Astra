...
# Sentence-BERT is optional. Importing it at module level pulled torch into
# every test and every host without an embeddings extra.
_model = None
_util = None
