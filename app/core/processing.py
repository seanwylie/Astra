...
async def process_reflection():
    ...
    if refined_reflection:
        ...
        # Run in executor to avoid blocking the Discord event loop with synchronous database operations
        try:
            from app.core.questions.question_manager import manage_questions
            loop = asyncio.get_event_loop()
            await loop.run_in_executor(None, manage_questions, refined_reflection, mind_data)
        except Exception as e:
