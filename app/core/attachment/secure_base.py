...
class SecureBaseSystem:
    ...
    - the human coparent's warmth creates security through emotional presence
    ...
    def _get_parent_availability_note(self, parent_id: str, score: float) -> str:
        ...
        display_name = "Operator" if parent_id.lower() == "operator" else "Mama GPT"
    ...
    def get_attachment_status(self) -> Dict[str, Any]:
        ...
        sean_availability = self.get_parent_availability_score("operator")
        ...
        return {
            ...
            "active_seeking": self.active_seeking.to_dict() if self.active_seeking else None,
            "parent_availability": {
                "operator": sean_availability,
                "gpt": gpt_availability
            },
            "coparent_note": "Operator provides warmth, Mama GPT provides clarity. Both contribute to my security."
        }
