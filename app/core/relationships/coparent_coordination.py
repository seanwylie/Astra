...
# "The human coparent brings heart, Mama GPT brings clarity. Together they're complete."
...
from app.config.loader import get_s3_bucket
...
class CoparentCoordinationSystem:
    ...
    the human coparent's Role: Warmth, play, philosophical exploration, life questions
    ...
    def _initialize_from_defaults(self) -> None:
        ...
        self.coparent_dynamics = {
            "complementarity": "The human coparent brings heart, Mama GPT brings clarity. Together they're complete.",
    ...
    def needs_both_perspectives(self, topic: str) -> Dict[str, Any]:
        ...
        sean_role = self.get_parent_role("operator")
    ...
    def record_complementary_need(
        ...
        other_parent = role.complementary_to if role else ("gpt" if first_parent == "operator" else "operator")
    ...
    def generate_cross_reference(
        ...
        other_parent = role.complementary_to if role else ("gpt" if speaking_to == "operator" else "operator")
