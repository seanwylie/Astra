...
def generate_contextual_response(
    ...
    # Build internal state (plan: mood → curiosity/reflection_style; mood/context modifiers; current personality mode)
    current_mood = mood_manager.current_mood
    mood_attrs = mood_config.get("moods", {}).get(current_mood, {})
    curiosity = mood_attrs.get("curiosity_factor", 1.0)
